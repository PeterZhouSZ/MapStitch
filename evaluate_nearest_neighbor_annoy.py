...
def generate_hashes(images, filename_corners, filename_edges):
	...
	edge_index = AnnoyIndex(channels * images.shape[1], metric='euclidean')  # Length of item vector that will be indexed
	...
	for idx, image in enumerate(tqdm(images)):
		...
		ct += 4
	corner_index.build(20)  # 10 trees
	edge_index.build(20)  # 10 trees
