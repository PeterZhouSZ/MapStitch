...
def download_tiles(zoom, lat_start, lat_stop, lon_start, lon_stop, keyfile, size=640, labels=False, maptype='terrain'):
	...
	api_key_1 = getAPIKeyFromFile(keyfile, 0)
	api_key_2 = getAPIKeyFromFile(keyfile, 3)
...
if __name__ == "__main__":
	...
	#lats_start = [37.454265, 16.724174,   2.797655, 38.153457, 17.627008, 20.274436]
	#lons_start = [-8.346962, 97.022732, 120.834965, 23.984985, -63.065185, -156.227417]

	lats_start = [  21.710227,   21.047817,   22.251447,  -5.324124,   3.396047,  11.449742,  -7.719837,  10.621467, 12.413442,   -2.960336, 23.108470]
	lons_start = [-158.290100, -156.723175, -159.793854, 134.086304, 105.495758, 113.997803, 127.521973, 119.304199, 123.459778, 107.493599, 38.733215]
	lats_end = [  21.237382,   20.525271,   21.864526,  -6.995267,   2.707637,   9.478186,  -8.274689,   1.914385,  11.672074,  -3.021165, 22.246840]
	lons_end = [-157.633667, -155.948639, -159.274750, 134.976196, 106.621856, 117.870483, 130.191651, 121.237793, 124.866028, 107.548420, 39.145202]
							#CALIFORNIA  #CHILE COAST  #ALASKA   #GREEK ISLANDS:##OAHU: 21.710227, -158.290100#MAUI: 21.047817, -156.723175#KAUAI: 22.251447, -159.793854#-5.324124, 134.086304#GOOD:3.396047, 105.495758#11.449742, 113.997803#-7.719837, 127.521973#10.621467, 119.304199#12.413442, 123.459778##ISLANDS_SEASIA-2.960336, 107.493599#KAUST#23.108470, 38.733215
	#lats_end   = [ 35.725452,  8.584933, -4.754361, 36.175020, 11.849879, 18.825067]
	#lons_end   = [11.428428, 98.692654, 135.073246, 27.907104, -60.516357, -154.645386]
		#lat_stop, lon_stop = ##CALIFORNIA##CHILE COAST##ALASKA: ##GREEK ISLANDS:##OAHU: 21.237382, -157.633667#MAUI: 20.525271, -155.948639#KAUAI: 21.864526, -159.274750#-6.995267, 134.976196#GOOD:`2.707637, 106.621856#9.478186, 117.870483#-8.274689, 130.191651#1.914385, 121.237793#11.672074, 124.866028##ISLANDS_SEASIA-3.021165, 107.548420#KAUST#22.246840, 39.145202
